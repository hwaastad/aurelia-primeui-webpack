...
module.exports = {
  resolve: {
    ...
    alias: {
      ...
      'amcharts.pie': node_dir + '/amcharts/dist/amcharts/pie.js',
      'amcharts.serial': node_dir + '/amcharts/dist/amcharts/serial.js',
      'amcharts.export': node_dir + '/amcharts/dist/amcharts/plugins/export/export.js'
    },
    /*  alias: {
